<xsl:stylesheet exclude-result-prefixes="xs xsl zgw" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:zgw="http://google.com/zgw"  version="2.0">
    ...
    <xsl:param name="BeginRegistratie" select="''" as="xs:string" />
    ...
    <xsl:param name="Ondertekening" as="node()"><ondertekening><soort /><datum xsi:nil="true" /></ondertekening></xsl:param>
    <xsl:param name="Integriteit" as="node()"><integriteit><algoritme /><waarde /><datum xsi:nil="true" /></integriteit></xsl:param>
    ...
    <xsl:template match="/">
        <ZgwEnkelvoudigInformatieObject>
            ...
            <xsl:copy-of select="zgw:WrapNullOrSkip('beginRegistratie', 'skip', zgw:FromOrderedSource(
                    $BeginRegistratie,
                    $ZgwEnkelvoudigInformatieObject/ZgwEnkelvoudigInformatieObject/beginRegistratie,
                    '', 
