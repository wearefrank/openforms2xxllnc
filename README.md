...
|-------------------------------|------------------------------------------------------------------------------------------------|----------------|
| `Openforms2xxllnc`            | The name of the Frank! to be deployed. It's best to keep this inline with the name of the repo | Frank2Skeleton |
| `openforms2xxllnc`         | Lowercase version of the instance name.                                                        | frank2example  |
| `xxllnc`       | The name of the first configuration (others have to be added manually)                         | Sans           |
